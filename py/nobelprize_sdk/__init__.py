...
from nobelprize_sdk.utility import register

# Load features
from nobelprize_sdk.feature.base_feature import NobelPrizeBaseFeature
from nobelprize_sdk.features import _has_feature, _make_feature
...
class NobelPrizeSDK:
    ...
    def get_utility(self):
        return NobelPrizeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NobelPrizeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Laureate(self, data=None) -> "LaureateEntity":
        ...
        from nobelprize_sdk.entity.laureate_entity import LaureateEntity
        return LaureateEntity(self, data)


    def Prize(self, data=None) -> "PrizeEntity":
        """Entity factory: client.Prize().list() / client.Prize().load({"id": ...})."""
        from nobelprize_sdk.entity.prize_entity import PrizeEntity
