...
from nobelprize_sdk.core.helpers import get_ctx_prop, to_map
...
class NobelPrizeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NobelPrizeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NobelPrizeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NobelPrizeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NobelPrizeError(code, msg, self)
