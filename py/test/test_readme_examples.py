# NobelPrize SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NobelPrizeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NobelPrizeSDK(...) and NobelPrizeSDK.test(...) become
#      NobelPrizeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nobelprize_sdk"
_SDK_CLASS = "NobelPrizeSDK"
