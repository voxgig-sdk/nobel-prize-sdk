...
class NobelPrizeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NobelPrizeTestRunner.getenv("NOBELPRIZE_TEST_LIVE")
        override = NobelPrizeTestRunner.getenv("NOBELPRIZE_TEST_OVERRIDE")
        ...
        explain = NobelPrizeTestRunner.getenv("NOBELPRIZE_TEST_EXPLAIN")
