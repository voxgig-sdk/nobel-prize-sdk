...
const testSeed = `map[string]any{"entity": map[string]any{"laureate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "prize": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
