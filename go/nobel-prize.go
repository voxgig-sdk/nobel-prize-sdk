...
// instead of `sdk.NewNobelPrizeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NobelPrizeSDK  { return NewNobelPrizeSDK(nil) }
func Test() *NobelPrizeSDK { return TestSDK(nil, nil) }
