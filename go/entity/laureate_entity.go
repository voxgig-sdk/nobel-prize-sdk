...
func NewLaureateEntity(client *core.NobelPrizeSDK, entopts map[string]any) *LaureateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LaureateEntity) GetName() string { return e.name }
...
func (e *LaureateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LaureateEntity) Deleted() bool {
	return e.deleted
}


func (e *LaureateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLaureateEntity(e.client, opts)
}

func (e *LaureateEntity) Data(args ...any) any {
...
func (e *LaureateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Laureate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LaureateEntity) DataTyped(data ...Laureate) Laureate {
	if len(data) > 0 {
		return typedFrom[Laureate](e.Data(asMap(data[0])))
	}
	return typedFrom[Laureate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Laureate (all fields
// optional at the wire level).
func (e *LaureateEntity) MatchTyped(match ...Laureate) Laureate {
	if len(match) > 0 {
		return typedFrom[Laureate](e.Match(asMap(match[0])))
	}
	return typedFrom[Laureate](e.Match())
}
...
func (e *LaureateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LaureateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LaureateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LaureateListMatch and returns []Laureate. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LaureateEntity) ListTyped(reqmatch LaureateListMatch, ctrl map[string]any) ([]Laureate, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Laureate](res), nil
}



func (e *LaureateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LaureateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LaureateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LaureateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
