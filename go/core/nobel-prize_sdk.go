...
func (sdk *NobelPrizeSDK) OptionsMap() map[string]any {
...
func (sdk *NobelPrizeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NobelPrizeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NobelPrizeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NobelPrizeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NobelPrizeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NobelPrizeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NobelPrizeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NobelPrizeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NobelPrizeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NobelPrizeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
