...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/nobel-prize` | `npm install @voxgig-sdk/nobel-prize` |
| Python | `voxgig-sdk-nobel-prize` | `pip install voxgig-sdk-nobel-prize` |
| PHP | `voxgig-sdk/nobel-prize` | `composer require voxgig-sdk/nobel-prize` |
| Golang | `github.com/voxgig-sdk/nobel-prize-sdk/go` | `go get github.com/voxgig-sdk/nobel-prize-sdk/go` |
| Ruby | `voxgig-sdk-nobel-prize` | `gem install voxgig-sdk-nobel-prize` |
| Lua | `voxgig-sdk-nobel-prize` | `luarocks install voxgig-sdk-nobel-prize` |
