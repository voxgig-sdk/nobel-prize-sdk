...
Results: Successful response with laureate data.
...
Results: Successful response with prize data.
...
| --- | --- | --- | --- |
| Laureate | `list` | `GET /laureate.json` | See reference |
| Prize | `list` | `GET /prize.json` | See reference |

## Connect to the API

- Production API Server (v1): `https://api.nobelprize.org/v1`
- Production API Server (v2.1): `https://api.nobelprize.org/2.1`
...
- `nobel-prize_list`: List records for an entity. Supported entities: `laureate`, `prize`.
- `nobel-prize_load`: Load one record for an entity. No active entity supports this operation.
