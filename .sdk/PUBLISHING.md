...
|---|---|---|
| `ts/` | @voxgig-sdk/nobel-prize-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nobel-prize-sdk \
      --repository voxgig-sdk/nobel-prize-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nobel-prize-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nobel-prize-sdk --id=<id>` removes it.
