...
class NobelPrizeCacheFeature extends NobelPrizeBaseFeature
{
    ...
    private function _through(NobelPrizeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
