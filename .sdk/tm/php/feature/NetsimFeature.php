...
class NobelPrizeNetsimFeature extends NobelPrizeBaseFeature
{
    ...
    private function _simulate(NobelPrizeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NobelPrizeContext $ctx, array $applied): void
    {
        $client = $this->client;
