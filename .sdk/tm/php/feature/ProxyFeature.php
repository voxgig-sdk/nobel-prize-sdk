...
class NobelPrizeProxyFeature extends NobelPrizeBaseFeature
{
    ...
    public function init(NobelPrizeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NobelPrizeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
