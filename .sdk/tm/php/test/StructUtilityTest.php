...
// NobelPrize SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NobelPrizeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NobelPrizeOmni::structfix($now, Struct::undef()))
                        !== json_encode(NobelPrizeOmni::structfix($val, Struct::undef()))) {
