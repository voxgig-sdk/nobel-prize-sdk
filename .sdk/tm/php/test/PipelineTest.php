...
{
    private static function utility(): NobelPrizeUtility
    {
        return new NobelPrizeUtility();
    }
    ...
    private static function ctx(array $over = []): NobelPrizeContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NobelPrizeContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NobelPrizeOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NobelPrizeError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NobelPrizeOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NobelPrizeMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NobelPrizeOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NobelPrizeMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NobelPrizeOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NobelPrizeMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NobelPrizeSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NobelPrizeMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NobelPrizeResponse([]),
            'result' => new NobelPrizeResult([]),
        ]);
        [, $err] = NobelPrizeMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NobelPrizeSpec([]),
            'response' => null,
            'result' => new NobelPrizeResult([]),
        ]);
        [, $err] = NobelPrizeMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NobelPrizeSpec(['step' => 's']),
            'response' => new NobelPrizeResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NobelPrizeResult([]),
        ]);
        [, $err] = NobelPrizeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NobelPrizeSpec(['step' => 's']),
            'response' => new NobelPrizeResponse(self::resp(200, ['v' => 1])),
            'result' => new NobelPrizeResult([]),
        ]);
        [, $err] = NobelPrizeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NobelPrizeSpec(['step' => 's']),
            'response' => new NobelPrizeResponse(self::resp(200, ['v' => 2])),
            'result' => new NobelPrizeResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NobelPrizeMakeResponse::call($ctx);
    ...
    {
        $preset = new NobelPrizeResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NobelPrizeSpec([]),
            'response' => new NobelPrizeResponse([]),
            'result' => new NobelPrizeResult([]),
        ...
        [$got, $err] = NobelPrizeMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NobelPrizeResult([])]);
        [, $err] = NobelPrizeMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NobelPrizeSpec([]), 'result' => null]);
        [, $err] = NobelPrizeMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NobelPrizeSpec(['step' => 's']),
            'result' => new NobelPrizeResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NobelPrizeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NobelPrizeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NobelPrizeSpec(['step' => 's']),
            'result' => new NobelPrizeResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NobelPrizeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NobelPrizeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NobelPrizeResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NobelPrizeSpec([]),
            'result' => new NobelPrizeResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NobelPrizeMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NobelPrizeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NobelPrizeError('boom', 'boom');
        $utility->fetcher = function (NobelPrizeContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NobelPrizeSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NobelPrizeMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NobelPrizeContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NobelPrizeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NobelPrizeResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NobelPrizeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NobelPrizeContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NobelPrizeSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NobelPrizeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NobelPrizeResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NobelPrizeSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NobelPrizeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NobelPrizeMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NobelPrizeMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NobelPrizeResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NobelPrizeDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NobelPrizeResult(['ok' => false])]);
        $this->expectException(NobelPrizeError::class);
        NobelPrizeDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NobelPrizeResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NobelPrizeMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NobelPrizeMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NobelPrizeBaseFeature();
        $b = new NobelPrizeBaseFeature();
        NobelPrizeFeatureAdd::call($ctx, $a);
        NobelPrizeFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NobelPrizeBaseFeature
    {
        $f = new NobelPrizeBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NobelPrizeFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NobelPrizeContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NobelPrizeSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NobelPrizePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NobelPrizePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NobelPrizeResponse(['headers' => null]),
            'result' => new NobelPrizeResult([]),
        ]);
        NobelPrizeResultHeaders::call($ctx);
