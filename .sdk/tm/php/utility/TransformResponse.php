...
// NobelPrize SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NobelPrizeTransformResponse
{
    public static function call(NobelPrizeContext $ctx): mixed
    {
        ...
        $transform = NobelPrizeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
