...
// NobelPrize SDK utility: fetcher

class NobelPrizeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NobelPrizeSDK/1.0)';
    ...
    public static function call(NobelPrizeContext $ctx, string $fullurl, array $fetchdef): array
    {
