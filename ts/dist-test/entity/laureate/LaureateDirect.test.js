...
(0, node_test_1.describe)('LaureateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NobelPrizeSDK({
    ...
    (0, node_test_1.test)('direct-list-laureate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-laureate', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NOBEL_PRIZE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NobelPrizeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NOBEL_PRIZE_TEST_LAUREATE_ENTID'];
    ...
    const client = new __1.NobelPrizeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LaureateDirect.test.js.map