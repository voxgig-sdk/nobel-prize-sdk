...
(0, node_test_1.describe)('PrizeEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/prize/PrizeTestData.json');
    ...
    let idmap = transform(['prize01', 'prize02', 'prize03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PrizeEntity.test.js.map