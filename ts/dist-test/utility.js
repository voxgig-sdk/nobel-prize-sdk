...
function envOverride(m) {
    if ('TRUE' === process.env.NOBEL_PRIZE_TEST_LIVE ||
        'TRUE' === process.env.NOBEL_PRIZE_TEST_OVERRIDE) {
    ...
    m.NOBEL_PRIZE_TEST_EXPLAIN = process.env.NOBEL_PRIZE_TEST_EXPLAIN || m.NOBEL_PRIZE_TEST_EXPLAIN;
    return m;
}
