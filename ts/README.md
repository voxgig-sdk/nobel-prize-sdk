# NobelPrize TypeScript SDK



The TypeScript SDK for the NobelPrize API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Laureate()` — each with a small set of operations (`list`)
...
| Method | Returns | Description |
| --- | --- | --- |
| `NobelPrizeSDK.test(testopts?, sdkopts?)` | `NobelPrizeSDK` | Create a test-mode client. |
...
| `client` | `client(): NobelPrizeSDK` | Return the parent SDK client. |
...
nobel-prize/
├── src/
│   ├── NobelPrizeSDK.ts        # Main SDK class
