...
local NobelPrizeSDK = {}
NobelPrizeSDK.__index = NobelPrizeSDK
...
NobelPrizeSDK._make_feature = _make_feature


function NobelPrizeSDK.new(options)
  local self = setmetatable({}, NobelPrizeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function NobelPrizeSDK:options_map()
...
function NobelPrizeSDK:get_utility()
  return Utility.copy(self._utility)
end


function NobelPrizeSDK:get_root_ctx()
  return self._rootctx
end


function NobelPrizeSDK:prepare(fetchargs)
...
function NobelPrizeSDK:direct(fetchargs)
...
-- by passing it.
function NobelPrizeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function NobelPrizeSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "NobelPrizeSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function NobelPrizeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = NobelPrizeSDK.new(sdkopts)
  sdk.mode = "test"
