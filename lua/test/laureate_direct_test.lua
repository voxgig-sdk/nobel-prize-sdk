...
describe("LaureateDirect", function()
  it("should direct-list-laureate", function()
    local setup = laureate_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-laureate", setup.live and "live" or "unit")
...
function laureate_direct_setup(mockres)
