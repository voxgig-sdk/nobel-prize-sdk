...
function runner.env_override(m)
  local live = runner.getenv("NOBEL_PRIZE_TEST_LIVE")
  local override = runner.getenv("NOBEL_PRIZE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NOBEL_PRIZE_TEST_EXPLAIN")
