...
describe("PrizeEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Prize(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Prize(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set NOBEL_PRIZE_TEST_PRIZE_ENTID JSON to run live")
      return
    end
...
function prize_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("NOBEL_PRIZE_TEST_PRIZE_ENTID")
