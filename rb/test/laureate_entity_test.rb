...
class LaureateEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NOBEL_PRIZE_TEST_LAUREATE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def laureate_basic_setup(extra)
  ...
  entid_env_raw = ENV["NOBEL_PRIZE_TEST_LAUREATE_ENTID"]
