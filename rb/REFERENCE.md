# NobelPrize Ruby SDK Reference

Complete API reference for the NobelPrize Ruby SDK.
...
#### `NobelPrizeSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Laureate.list(nil)
```
