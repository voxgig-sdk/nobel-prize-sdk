...
require_relative 'NobelPrize_types'
...
class NobelPrizeSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = NobelPrizeHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = NobelPrizeHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, NobelPrizeFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    NobelPrizeUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = NobelPrizeHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = NobelPrizeHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = NobelPrizeHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = NobelPrizeHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = NobelPrizeError.new(
        "graphql_error", "NobelPrizeSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
