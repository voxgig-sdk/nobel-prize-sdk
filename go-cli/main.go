// Command NobelPrize-cli is a CLI + REPL for the NobelPrize SDK,
...
const prompt = "nobel-prize"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "laureate prize"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      NOBEL_PRIZE_APIKEY (api key), NOBEL_PRIZE_BASE (base url override)")
