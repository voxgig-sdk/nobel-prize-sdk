...
func registerSDKWords(r *eng.Registry, client *sdk.NobelPrizeSDK) {
...
func runOp(client *sdk.NobelPrizeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
