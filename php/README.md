...
The PHP SDK for the NobelPrize API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Laureate(null)->list(null, null);
...
[$result, $err] = $client->NobelPrize(null)->load(
    ["id" => "test01"], null
);
