...
// NobelPrize SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NobelPrizeMakeRequest
{
    public static function call(NobelPrizeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NobelPrizeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NobelPrizeResponse($fetched);
        } else {
