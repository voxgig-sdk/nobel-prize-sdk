...
// NobelPrize SDK utility: graphql
//
...
class NobelPrizeGraphql
{
    ...
    // equivalent.
    public static function body(NobelPrizeContext $ctx): mixed
    {
    ...
    public static function errors(NobelPrizeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
