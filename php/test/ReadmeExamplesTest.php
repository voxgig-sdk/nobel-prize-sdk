...
// NobelPrize SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NobelPrizeSDK::test)
...
{
    private const SDK_CLASS = 'NobelPrizeSDK';
    ...
    private const SDK_BASE = 'nobelprize_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nobelprize_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
