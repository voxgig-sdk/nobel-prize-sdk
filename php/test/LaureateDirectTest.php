...
class LaureateDirectTest extends TestCase
{
    public function test_direct_list_laureate(): void
    {
        $setup = laureate_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-laureate", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
