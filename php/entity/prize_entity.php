...
class PrizeEntity
{
    ...
    /**
     * @param Prize|array $args Prize data (assoc-array) to store.
     */
    ...
    /**
     * @return Prize|array The current Prize data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Prize fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Prize fields).
     */
     ...
     *
     * @param PrizeListMatch|array|null $reqmatch Match filter (any subset
     *   of Prize fields) as an assoc-array; PrizeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Prize[]|array A list of Prize items as assoc-arrays at
