...
// NobelPrize SDK ratelimit feature
...
class NobelPrizeRatelimitFeature extends NobelPrizeBaseFeature
{
    ...
    private function _acquire(NobelPrizeContext $ctx): void
    {
    ...
    private function _track(NobelPrizeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
