...
class NobelPrizeRbacFeature extends NobelPrizeBaseFeature
{
    ...
    private function _required(NobelPrizeContext $ctx): ?string
    {
    ...
    private function _reject(NobelPrizeContext $ctx, string $required): void
    {
    ...
    private function _track(NobelPrizeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
