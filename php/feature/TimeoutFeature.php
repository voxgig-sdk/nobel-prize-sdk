...
// NobelPrize SDK timeout feature
...
class NobelPrizeTimeoutFeature extends NobelPrizeBaseFeature
{
    ...
    private function _with_timeout(NobelPrizeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NobelPrizeContext $_ctx, float $ms): void
    {
        $client = $this->client;
