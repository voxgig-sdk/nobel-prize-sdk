...
// NobelPrize SDK clienttrack feature
...
class NobelPrizeClienttrackFeature extends NobelPrizeBaseFeature
{
    ...
    public function PostConstruct(NobelPrizeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NobelPrize-SDK';
