...
// NobelPrize SDK streaming feature
...
class NobelPrizeStreamingFeature extends NobelPrizeBaseFeature
{
    ...
    private function _iterate(NobelPrizeResult $result): \Generator
    {
    ...
    private function _streamable(NobelPrizeContext $ctx): bool
    {
