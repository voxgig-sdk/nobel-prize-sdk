...
// NobelPrize SDK telemetry feature
...
class NobelPrizeTelemetryFeature extends NobelPrizeBaseFeature
{
    ...
    private function _close(NobelPrizeContext $ctx, bool $ok): void
    {
