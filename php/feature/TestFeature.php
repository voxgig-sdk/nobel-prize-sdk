...
// NobelPrize SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NobelPrizeTestFeature extends NobelPrizeBaseFeature
{
    ...
    public function init(NobelPrizeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NobelPrizeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NobelPrizeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NobelPrizeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NobelPrizeContext $ctx, $op, $args): array
    {
