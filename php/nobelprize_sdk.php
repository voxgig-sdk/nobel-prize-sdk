...
class NobelPrizeSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = NobelPrizeHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = NobelPrizeHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!NobelPrizeFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, NobelPrizeFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return NobelPrizeUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = NobelPrizeHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = NobelPrizeHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = NobelPrizeHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new NobelPrizeError($op . "_allow",
                "NobelPrizeSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = NobelPrizeHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new NobelPrizeError("graphql_error",
                "NobelPrizeSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Laureate($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_laureate === null) {
                $this->_laureate = new LaureateEntity($this, null);
            }
            return $this->_laureate;
        }
        return new LaureateEntity($this, $data);
    }
    ...
    public function Prize($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_prize === null) {
                $this->_prize = new PrizeEntity($this, null);
            }
            return $this->_prize;
        }
