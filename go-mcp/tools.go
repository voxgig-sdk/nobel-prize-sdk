...
func registerTools(server *mcp.Server, client *sdk.NobelPrizeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nobel-prize_list",
		Description: "List records from NobelPrize. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nobel-prize_load",
		Description: "Load a single record from NobelPrize. " +
...
func runOp(client *sdk.NobelPrizeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NobelPrizeSDK, name string) (sdk.NobelPrizeEntity, error) {
