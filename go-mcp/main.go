// Command NobelPrize-mcp is an MCP server exposing the NobelPrize
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NobelPrize_list  — list records of an entity
//	NobelPrize_load  — load a single record of an entity
//
